...
function Navigation_Comp() {
  ...
  return (
    <div className="flex justify-between max-w-[1440px] items-center mx-auto px-10 py-2 ">
       <h1 className="text-4xl text-orange-500 font-bold text-center cursor-pointer">FNC</h1>
      ...
      <ul className="hidden md:flex space-x-4">
        ...
        <li className="text-2xl text-white hover:text-teal-100 duration-1000 ease-in-out cursor-pointer"> </li>
      ...
      <div className={nav ? 'fixed left-0 top-0 w-[90%] h-full border-r border-r-gray-700 ease-in-out duration-500 lg:hidden' : 'fixed left-[-100%]'}>
        ...
        <div className=" ">
          <h1 className="w-full text-4xl text-white font-bold mt-4 px-8 select-none">FNC</h1>
        </div>
